...
namespace Xsolla.Core
{
	...
	{
		public void PostRequest<T, D>(string url, D jsonObject, List<WebRequestHeader> requestHeaders,
		...
		public void PostRequest<T, D>(string url, D jsonObject, Action<T> onComplete = null,
		...
		public void PostRequest<T>(string url, List<WebRequestHeader> requestHeaders, Action<T> onComplete = null,
			Action<Error> onError = null)
			where T : class
		{
		...
		public void PostRequest<D>(string url, D jsonObject, List<WebRequestHeader> requestHeaders,
			Action onComplete = null, Action<Error> onError = null)
			where D : class
		{
			StartCoroutine(PostRequestCor(url, jsonObject, requestHeaders, onComplete, onError));
		}

		public void PostRequest<D>(string url, D jsonObject = null, Action onComplete = null,
			Action<Error> onError = null)
			where D : class
		{
		...
		public void PostRequest(string url, List<WebRequestHeader> requestHeaders, Action<string> onComplete = null,
			Action<Error> onError = null)
		{
			StartCoroutine(PostRequestCor(url, null, requestHeaders, onComplete, onError));
		}
		...
		public void PostRequest(string url, List<WebRequestHeader> requestHeaders, Action onComplete = null,
			Action<Error> onError = null)
		{
			StartCoroutine(PostRequestCor(url, null, requestHeaders, onComplete, onError));
		}
		...
		IEnumerator PostRequestCor(string url, object jsonObject, List<WebRequestHeader> requestHeaders,
			Action onComplete = null, Action<Error> onError = null)
		{
		...
		IEnumerator PostRequestCor(string url, object jsonObject, List<WebRequestHeader> requestHeaders,
			Action<string> onComplete = null, Action<Error> onError = null)
		{
			UnityWebRequest webRequest = PreparePostWebRequest(url, jsonObject, requestHeaders);
		...
		IEnumerator PostRequestCor<T>(string url, object jsonObject, List<WebRequestHeader> requestHeaders,
			Action<T> onComplete = null, Action<Error> onError = null) where T : class
		{
			UnityWebRequest webRequest = PreparePostWebRequest(url, jsonObject, requestHeaders);
		...
		private UnityWebRequest PreparePostWebRequest(string url, object jsonObject,
			List<WebRequestHeader> requestHeaders)
		{
